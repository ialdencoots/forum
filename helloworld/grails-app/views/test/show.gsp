		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="test.password.label" default="Password" /></span>
					
						<span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${testInstance}" field="password"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${testInstance?.userName}">
				<li class="fieldcontain">
					<span id="userName-label" class="property-label"><g:message code="test.userName.label" default="User Name" /></span>
					
						<span class="property-value" aria-labelledby="userName-label"><g:fieldValue bean="${testInstance}" field="userName"/></span>
